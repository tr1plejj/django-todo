...
SECRET_KEY = 'django-insecure-002l9pl+hs6h&7a-ozccny#79ub9_)!$!jeh@h&ea&cyypg*_p'
...
REST_FRAMEWORK = {'DEFAULT_PERMISSIONS_CLASSES': ('rest_framework.permissions.AllowAny',),
                  'DEFAULT_AUTHENTICATION_CLASSES': (
                        ...
                        'rest_framework.authentication.TokenAuthentication',)}  # allows the web app to user both session and token auth
